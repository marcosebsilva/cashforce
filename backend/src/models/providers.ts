...
export type providersOptionalAttributes =
    | "id"
    | "tradingName"
    | "cashforceTax"
    | "responsibleName"
    ...
    | "cnpjId"
    | "email";
export type providersCreationAttributes = Optional<
    providersAttributes,
    providersOptionalAttributes
>;

export class providers
    extends Model<providersAttributes, providersCreationAttributes>
