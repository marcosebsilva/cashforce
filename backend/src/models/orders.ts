    ...
    implements ordersAttributes
{
    ...
    setOrderportions!: Sequelize.HasManySetAssociationsMixin<
        orderportions,
        orderportionsId
    >;
    addOrderportion!: Sequelize.HasManyAddAssociationMixin<
        orderportions,
        orderportionsId
    >;
    addOrderportions!: Sequelize.HasManyAddAssociationsMixin<
        orderportions,
        orderportionsId
    >;
    createOrderportion!: Sequelize.HasManyCreateAssociationMixin<orderportions>;
    removeOrderportion!: Sequelize.HasManyRemoveAssociationMixin<
        orderportions,
        orderportionsId
    >;
    removeOrderportions!: Sequelize.HasManyRemoveAssociationsMixin<
        orderportions,
        orderportionsId
    >;
    hasOrderportion!: Sequelize.HasManyHasAssociationMixin<
        orderportions,
        orderportionsId
    >;
    hasOrderportions!: Sequelize.HasManyHasAssociationsMixin<
        orderportions,
        orderportionsId
    >;
    ...
    setProvider!: Sequelize.BelongsToSetAssociationMixin<
        providers,
        providersId
    >;
            ...
            },
            {
                ...
                indexes: [
                    ...
                    },
                    {
                        ...
                        unique: true,
                        using: "BTREE",
                        fields: [{ name: "orderNfId" }],
                    },
                    {
                        name: "orderPath",
                        unique: true,
                        using: "BTREE",
                        fields: [{ name: "orderPath" }],
                    },
                    {
                        name: "orderFileName",
                        unique: true,
                        using: "BTREE",
                        fields: [{ name: "orderFileName" }],
                    },
                    {
                        name: "orderOriginalName",
                        unique: true,
                        using: "BTREE",
                        fields: [{ name: "orderOriginalName" }],
                    },
                    {
                        name: "userId",
                        using: "BTREE",
