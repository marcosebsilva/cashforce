...
export type offersOptionalAttributes =
    | "id"
    ...
    | "orderId"
    | "sponsorId";
export type offersCreationAttributes = Optional<
    offersAttributes,
    offersOptionalAttributes
>;

export class offers
    extends Model<offersAttributes, offersCreationAttributes>
    implements offersAttributes
{
    id!: number;
    tax!: string;
    tariff!: string;
