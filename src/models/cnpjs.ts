...
export type cnpjsOptionalAttributes = "id" | "createdAt" | "updatedAt";
export type cnpjsCreationAttributes = Optional<
    cnpjsAttributes,
    cnpjsOptionalAttributes
>;

export class cnpjs
    extends Model<cnpjsAttributes, cnpjsCreationAttributes>
    implements cnpjsAttributes
{
    id!: number;
    cnpj!: string;
    companyType!: string;
    ...
    setProviders!: Sequelize.HasManySetAssociationsMixin<
        providers,
        providersId
    >;
    addProvider!: Sequelize.HasManyAddAssociationMixin<providers, providersId>;
    addProviders!: Sequelize.HasManyAddAssociationsMixin<
        providers,
        providersId
    >;
    createProvider!: Sequelize.HasManyCreateAssociationMixin<providers>;
    removeProvider!: Sequelize.HasManyRemoveAssociationMixin<
        providers,
        providersId
    >;
    removeProviders!: Sequelize.HasManyRemoveAssociationsMixin<
        providers,
        providersId
    >;
    hasProvider!: Sequelize.HasManyHasAssociationMixin<providers, providersId>;
    hasProviders!: Sequelize.HasManyHasAssociationsMixin<
        providers,
        providersId
    >;
    ...
    removeSponsor!: Sequelize.HasManyRemoveAssociationMixin<
        sponsors,
        sponsorsId
    >;
    removeSponsors!: Sequelize.HasManyRemoveAssociationsMixin<
        sponsors,
        sponsorsId
    >;
