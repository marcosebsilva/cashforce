...
export type orderportionsOptionalAttributes =
    | "id"
    | "availableToMarket"
    | "createdAt"
    | "updatedAt"
    | "orderId";
export type orderportionsCreationAttributes = Optional<
    orderportionsAttributes,
    orderportionsOptionalAttributes
>;

export class orderportions
    extends Model<orderportionsAttributes, orderportionsCreationAttributes>
    implements orderportionsAttributes
{
    id!: number;
    nDup!: string;
    dVenc!: string;
