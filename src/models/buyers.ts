...
export type buyersOptionalAttributes =
    | "id"
    | "tradingName"
    | "cashforceTax"
    | "responsibleName"
    ...
    | "confirm"
    | "email";
export type buyersCreationAttributes = Optional<
    buyersAttributes,
    buyersOptionalAttributes
>;

export class buyers
    extends Model<buyersAttributes, buyersCreationAttributes>
    implements buyersAttributes
{
    id!: number;
    name!: string;
    tradingName?: string;
