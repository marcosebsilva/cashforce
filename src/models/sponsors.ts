...
export type sponsorsOptionalAttributes =
    | "id"
    | "tradingName"
    | "cashforceTax"
    | "responsibleName"
    ...
    | "cnpjId"
    | "email";
export type sponsorsCreationAttributes = Optional<
    sponsorsAttributes,
    sponsorsOptionalAttributes
>;

export class sponsors
    extends Model<sponsorsAttributes, sponsorsCreationAttributes>
    implements sponsorsAttributes
{
    id!: number;
    name!: string;
    tradingName?: string;
